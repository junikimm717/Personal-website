  ...
  <Page title="School">
    ...
    <CardGroup>
      <Card title="2020-21 AP Calculus BC TA">
        ...
        holding office hours and review sessions for major tests.
      </Card>
      <Card title="2021-22 Peer Tutor for Mathematics and Chemistry">
        For the 2021-22 School year, I am the peer tutor of all mathematics
        subjects up to Calculus BC and all chemistry classes.
      </Card>
